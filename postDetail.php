          ...
          <div class="flex-box">
            <div class="flex-item fi-lg-8x fi-md-12x fi-sm-12x">
              <div class="container-fluid">
                <h4>နည်းပညာတက္ကသိုလ် (ရတနာပုံဆိုင်ဘာစီးတီး)တွင် စာမေးပွဲ အောင်စာရင်းများ ထွက်ရှိ</h4>
                <label class="post-status"><span class="ui-icons ui-1_calendar-60"></span>26-9-2017</label>
                  ...
                  <div class="flex-item fi-lg-4x fi-md-6x fi-sm-12x">
                    <div class="container-fluid">
                      <div class="img-container">
                        <img class="open-light-box" src="stock-img/cover1.jpg" alt="" data="stock-img/cover3.jpg">
                      </div>
                    </div>
                  </div>
                  <div class="flex-item fi-lg-4x fi-md-6x fi-sm-12x">
                    <div class="container-fluid">
                      <div class="img-container">
                        <img class="open-light-box" src="stock-img/cover2.jpg" alt="" data="stock-img/cover3.jpg">
                      </div>
                    </div>
                  </div>
                  <div class="flex-item fi-lg-4x fi-md-6x fi-sm-12x">
                    <div class="container-fluid">
                      <div class="img-container">
                        <img class="open-light-box" src="stock-img/cover4.jpg" alt="" data="stock-img/cover3.jpg">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="flex-item fi-lg-12x fi-md-12x fi-sm-12x post-container">
                    <a href="#">
                      <div class="container-fluid card">
                        <h5 class="bold">Lorem ipsum dolor sit amet, consectetur မြန်မာစာနည်းနည်း ဝင်ပြီးရေးကြည့်တာ adipisicing elit, sed do eiusmod tempor.</h5>
                        <label class="post-status"><span class="ui-icons ui-1_calendar-60"></span>26-9-2017</label>
                      </div>
                    </a>
                  </div>
