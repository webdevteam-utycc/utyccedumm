...
<html>
  <head>
    ...
    <link rel="stylesheet" href="css/custom.css">
      <title>UT-YCC | Faculty / ICT / CE</title>
  </head>
    <body id="istPage">
    <div class="loader">
        ...
        <div class="page-cover">
            <div class="page-cover-overlay">
                ...
                <div class="page-title">
                    <h1>Faculty</h1>
                    <label class="page-location"><a href="index.php">Home</a> / <a href="faculty.php">Faculty</a> / <a href="ict.php">ICT</a> / CE</label>
                </div>
            </div>
        </div>
        <div class="section">
