    ...
    <div class="bg-white border shadow-sm d-inline-block px-4 text-center floated-navigate1">
          ...
          <div class="p-3 flex-grow">
					<div class="bg-white border shadow-sm d-inline-block px-4 text-center floated-navigate">
						...
						<a href="ukl86mx4/index.php?id=<?php echo $_SESSION['token']?>"><span class="fas fa-vote-yea d-block my-5 " style="font-size;18.667px;"     data-toggle="tooltip" data-placement="right" title="vote"></span></a>
<!--						<a href="account.php"><span class="fas fa-cogs fa-lg d-block my-5"  data-toggle="tooltip" data-placement="right" title="settings"></span></a>-->
						<hr>
						<a href="ukl86mx4/logout.php"><span class="fas fa-sign-out-alt fa-lg d-block my-5" data-toggle="tooltip" data-placement="right" title="Logout"></span></a>
          </div>
   ...
   <!-- Added by pwint -->
   <h5 class="mb-3 post-caption text-center my-3">***Top 3 Popular Posts***</h5>
                ...
                <div class="card-body pl-5 pr-5 pt-3 pb-3">
                  <div class="post-item-container">
                    <div class="d-flex align-items-center user-list-item">
                      <img class="profile-image rounded-circle mr-3" src="img/su.jpeg" alt="">
                      <span class="flex-grow-1 mb-1 ml-2" id="profile-info">Student Union<br><small>25 Jan 2019</small></span>
                    ...
                    <div class="d-flex align-items-center post-list-item border-bottom">
                      <div class="flex-grow-1 py-3">
                        ...
                        ယခုနှစ် အတွက် Fresher Welcomeကို မကြာမီ ကျင်းပတော့မည် ဖြစ်ပါသည်။</p>
                    ...
                    <div class="d-flex align-items-center post-list-item border-bottom">
                      <div class="flex-grow-1 py-3">
                        <!-- for 1 photo -->
                        <div class="row">
                          <img src="img/welcome.jpg" class="col-md-12 one-img" style="width: 100%;border-radius: 30px;" role="button" data-toggle="modal" data-target="#imgViewModal" onclick="currentSlide(1)">
                        </div>
              ...
              <div class="card shadow-sm">
                <div class="card-body pl-5 pr-5 pt-3 pb-3">
                  <div class="post-item-container">
                    <div class="d-flex align-items-center user-list-item">
                      <img class="profile-image rounded-circle mr-3" src="img/su.jpeg" alt="">
                      <span class="flex-grow-1 mb-1 ml-2" id="profile-info">Student Union<br><small>2 Sep 2018</small></span>
              ...
              <div class="card shadow-sm">
                <div class="card-body pl-5 pr-5 pt-3 pb-3">
                  <div class="post-item-container">
                    <div class="d-flex align-items-center user-list-item">
                      <img class="profile-image rounded-circle mr-3" src="img/su.jpeg" alt="">
                      <span class="flex-grow-1 mb-1 ml-2" id="profile-info">Student Union<br><small>24 Sep 2018</small></span>
