                    ...
                    <div class="container-fluid">
                        <div class="unit">
                            ...
                            <p class="text-justify">The 1<sup>st</sup> International Research Conference on Science and
                                ...
                                advances and research findings in theoretical, experimental and innovation in science
                                and engineering with leading experts and practices across the globe.
                            </p>
                        </div>
                            ...
                            <div class="container-fluid pc-only">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <del style="color:#856404;">15<sup>th</sup> December 2019</del>
                                            </span>
                                            <br>
                            ...
                            <div class="flex-box">
                                <div class="flex-item fi-lg-12x fi-md-12x fi-sm-12x committee_container">
                                    <div class="container-fluid alert"
                                         style="background-color: #fff3cd; border-color:#ffeeba; border-radius: .25rem;">
                                        <h4 style="color:#856404;">Special Announcement: The 1st IRCSE will be held
                                            Online</h4>

                                        <p style="color: #856404">Due to continued uncertainties surrounding the ongoing global coronavirus
                                            pandemic, the organizing committee has made the decision to conduct the 1st
                                            IRCSE entirely online via Zoom.<br>
                                    </div>
                                </div>
                            </div>
